        ...
        <img  src="{{ URL:: asset('assets/AdminLTE-2.4.0/dist/img/CintilloSITM.png')}}">
         ...
         <div style="top:32px" class="box">
            <div class="box-header">
              ...
              <a style="left: 34px; width: 10%; z-index: 2;" href="/agregar_tipoarticulo" class="btn btn-md btn-block btn-danger">Agregar Tipoarticulo</a>
            </div>
            ...
            <div class="box-body">
              <table id="listaarticulos" class="table table-bordered ">
                ...
                <tbody>
                     ...
                     @foreach($tipoarticulos  as $tipoarticulosView)
                      <tr>
                        <td>

                       
                        <td>{{ $tipoarticulosView->tipo_articulo_id}}</td>
                        <td>{{ $tipoarticulosView->dentipart}}</td>
                        <td>
                          <a href="/actualizar_tipoarticulo/{{$tipoarticulosView->tipo_articulo_id}}">
                             <i id="tooltip-events" title="Editar Tiporticulo" class="fa fa-fw fa-pencil"></i> 
                          </a>
                        </td>
