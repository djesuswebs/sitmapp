      ...
      <!--  <div style="padding: 0px, 34px, 0px, 34px;!important">
        <img  src="{{ URL:: asset('assets/AdminLTE-2.4.0/dist/img/CintilloSITM.png')}}">
         ...
         <div style="top:32px" class="box">
            ...
            <a style="left: 34px; width: 10%; z-index: 2;" href="/agregar_almacen" class="btn btn-block btn-danger">Agregar Almacen</a>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="listaarticulos" class="table table-bordered table-striped">
                ...
                <tbody>
                     ...
                     @foreach($almacen as $almacenView)
                      <tr>
                       	<td>{{ $almacenView->id_almacen }} </td>
                        <td>{{ $almacenView->denalmacen }}</td>
                        <td>{{ $almacenView->ubicacionfis}} </td>
                        
                        <td>
                          <a href="/actualizar_almacen/{{$almacenView->id_almacen}}">
                             <i id="tooltip-events" title="Editar Almacen" class="fa fa-fw fa-pencil"></i> 
                          </a>
                        </td>
                      </tr>
                      @endforeach
...
<script src="{{ asset('assets/AdminLTE-2.4.0/bower_components/bootstrap/dist/js/bootstrap.min.js')}}"></script>
  ...
  <script type="text/javascript">
    ...
    var table2 = $('#listaclientes').DataTable( {
        responsive: true,
        paging: true
    } );
