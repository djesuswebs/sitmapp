                ...
                <tbody>
                     @foreach($articulos as $articulosView)
                      <tr>
                          ...
                          <td>
                             <?php 
                                 $descripcionArticulo //=  $articulosView->denominacion;
                                 //if (strlen($descripcionArticulo) > 30) {
                                    //  $Contenido = substr( $descripcionArticulo, 0, 30) .'<span id="tooltip-events" class="tooltipstered"  title="'.$articulosView->denominacion.'">...</span>';
                                 // } else {
                                      // $Contenido =  $descripcionArticulo . '<span id="tooltip-events" class="tooltipstered"  title="'.$articulosView->denominacion.'">...</span>';
                                 // } 
                              
                               // echo '<span  id="tooltip-events" class="tooltipstered"  title="'.$articulosView->denominacion.'">'.$Contenido.'</span>';
                              ?>
                          </td>
                         <td>{{ $articulosView->presentacion }}</td>
                        <td>{{ $articulosView->modelo}}</td>
                        <td>{{ $articulosView->exiactart}}</td>
                        <td>{{ $articulosView->denalmacen}}</td>
