            ...
            <div class="box-body">
              <table id="listaarticulos" class="table table-bordered table-striped">
                ...
                <tbody>
                     ...
                     @foreach($cliente as $clienteView)
                      <tr>
                       	<td>{{ $clienteView->id_cliente }} </td>
                        <td>{{ $clienteView->nombre }}</td>
                        <td>{{ $clienteView->apellido}} </td>
                        <td>{{ $clienteView->telefono}} </td>
                        <td >{{ $clienteView->direccion}}</td>
                        <td >{{ $clienteView->email}}</td>
