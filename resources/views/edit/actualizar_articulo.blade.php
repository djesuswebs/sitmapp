...
<?php 
                ...
                use App\Fabricante as Fabricante;                //$proveedor = Proveedor::where('nombre_proveedor','like','%OILRED S.A.%')
                //->get();
          ...
          <div style="top:32px; margin-bottom: 72px;" class="box box-danger">
              ...
              <div class="row">
                ...
                <div class="col-xs-4">
                      ...
                      <?php if ($articuloEdit->img_articulo == NULL) {?>
                       <img height="243" width="243" src="../../../public/storage/articulos_default.png" class="img-circle" alt="Imagen Articulo ">
                      <?php } else {?>
                      <img height="243" width="243" src="../../../public/storage/<?php echo $articuloEdit->img_articulo?>" class="img-circle" alt="Imagen Articulo ">
                      <?php } ?>
                      <br>
                ...
                <div class="col-xs-2">
                 <label for="fecha_creacion_articulo" > Fecha de Creacion </label>
                  <input name="fecha_creacion_articulo" type="text" class="form-control" value="<?php echo $articuloEdit->feccreart?>">
                </div>
            ...
            <!-- /.box-body -->
                <div  class="box box-info">
                  <div class="box-header with-border">
                      <h3 class="box-title"><b> Datos Bancarios de: </b> <?php echo $articuloEdit->nombre_proveedor?></h3>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-3">
                       <label for="nit" > Tipo Cuenta </label>
                        <input name="tipo_cuenta_proveedor" type="text" class="form-control" value="<?php echo $articuloEdit->tipocuebanc?>">
                      </div>
                      <div class="col-xs-3">
                       <label for="nit" > Nro Cuenta: </label>
                        <input name="numero_cuenta__proveedor" type="text" class="form-control" value="<?php echo $articuloEdit->cuebanc?>">
                      </div>
              ...
              <button style="position: fixed; bottom: 104px; right: 34px;"  type="submit" class="btn btn-success">Guardar Articulo</button>
          </form>
        <?php } ?>
