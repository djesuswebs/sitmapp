  ...
  <div class="content-wrapper">
    ...
    <section style="height: 1944px;" class="content">
      ...
      <div style="padding: 0px, 34px, 0px, 34px;!important">
          ...
          <form  method="post" enctype="multipart/form-data" action="{{ route('guardar_fabricante')}}">
          ...
          <div style="top:32px; margin-bottom: 72px;" class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><b> Editar Fabricante</h3>
            </div>
            ...
            <div class="box-body">
              <div class="row">
               ...
               <?php foreach ($fabricante as $fabricanteEdit) { ?>
                ...
                <input type="hidden" name="id_fabricante" value="<?php echo $fabricanteEdit->fabricanteId ?>">

                  <div class="col-xs-2">
                   <label for="nit" > Nombre Fabricante </label>
                    <input name="nombre_fabricante" type="text" value="<?php echo $fabricanteEdit->denefabricante ?>" class="form-control">
                  </div>
            ...
            <!-- /.box-body -->
              ...
              <div >
                ...
                <button style="position: fixed; bottom: 104px; right: 34px;"  type="submit" class="btn btn-success">
                    <p class="rotate">Guardar Fabricante</p>
                </button>
