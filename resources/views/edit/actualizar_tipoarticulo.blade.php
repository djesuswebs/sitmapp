  ...
  <div class="content-wrapper">
    ...
    <section style="height: 1944px;" class="content">
      ...
      <div style="padding: 0px, 34px, 0px, 34px;!important">
          ...
          <form  method="post" enctype="multipart/form-data" action="{{ route('agregar_tipoarticulo')}}">
            ...
            <div class="box-body">
              <div class="row">
               ...
               <?php foreach ($tipoarticulo as $tipoarticuloEdit) { ?>
                ...
                <div class="col-xs-3">
                 <label for="nombre_articulo" > Nombre Tiporticulo </label>
                  <textarea name="nombre_tipoarticulo" type="text" class="form-control" rows="4"><?php echo $tipoarticuloEdit->dentipart;?></textarea>
                </div>
            ...
            <!-- /.box-body -->
              ...
              <div >
                ...
                <button style="position: fixed; bottom: 104px; right: 34px;"  type="submit" class="btn btn-success">
                    <p class="rotate">Agregar Tipoarticulo</p>
                </button>
