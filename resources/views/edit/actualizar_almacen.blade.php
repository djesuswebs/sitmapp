  ...
  <div class="content-wrapper">
    ...
    <section style="height: 1944px;" class="content">
      ...
      <div style="padding: 0px, 34px, 0px, 34px;!important">
          ...
          <form  method="post" enctype="multipart/form-data" action="{{ route('guardar_almacen')}}">
            ...
            <div class="box-body">
              <div class="row">
               ...
               <?php foreach ($almacen as $almacenEdit) { ?>
                ...
                <input type="hidden" name="id_almacen" value="<?php echo $almacenEdit->id_almacen ?>">

                  <div class="col-xs-2">
                   <label for="nit" > Nombre Almacen </label>
                    <input name="nombre_almacen" type="text" value="<?php echo $almacenEdit->denalmacen ?>" class="form-control">
                  </div>

                  <div class="col-xs-3">
                   <label for="nombre_articulo" > Ubicación Fisica </label>
                    <textarea name="ubicacion_almacen" type="text" class="form-control" rows="4"><?php echo $almacenEdit->ubicacionfis?></textarea>
                  </div>
            ...
            <!-- /.box-body -->
              ...
              <div >
                ...
                <button style="position: fixed; bottom: 104px; right: 34px;"  type="submit" class="btn btn-success">
                    <p class="rotate">Guardar Almacen</p>
                </button>
