  ...
  <div class="content-wrapper">
    ...
    <section style="height: 1944px;" class="content">
      ...
      <div style="padding: 0px, 34px, 0px, 34px;!important">
          ...
          <form  method="post" enctype="multipart/form-data" action="{{ route('agregar_manobra')}}">
          ...
          <div style="top:32px; margin-bottom: 72px;" class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><b> Agregar Manobra</h3>
            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-xs-2">
                   <label for="nit" > Nombre </label>
                    <input name="nombre_manobra" type="text" class="form-control">
                  </div>

                  <div class="col-xs-2">
                   <label for="nit" > Costo </label>
                    <input name="costo_manobra" type="text" class="form-control">
                  </div>


                  <div class="col-xs-3">
                   <label for="nombre_articulo" > Descripcion</label>
                    <textarea name="descripcion_manobra" type="text" class="form-control" rows="4"></textarea>
                  </div>
