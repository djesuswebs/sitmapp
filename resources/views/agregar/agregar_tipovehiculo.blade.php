  ...
  <div class="content-wrapper">
    ...
    <section style="height: 1944px;" class="content">
      ...
      <div style="padding: 0px, 34px, 0px, 34px;!important">
          ...
          <form  method="post" enctype="multipart/form-data" action="{{ route('agregar_tipovehiculo')}}">
            ...
            <div class="box-body">
              <div class="row">
                  ...
                  <div class="col-xs-2">
                   <label for="nit" > Marca Vehiculo </label>
                    <input name="marca_vehiculo" type="text" class="form-control">
                  </div>

                   <div class="col-xs-3">
                       <label for="nombre_proveedor" > Desde el Año:</label>
                        <input name="desde_vehiculo" type="text" class="form-control" >
                      </div>
                      <div class="col-xs-2">
                       <label for="nit" > Hasta el Año </label>
                        <input name="hasta_vehiculo" type="text" class="form-control" >
                      </div>
                      <div class="col-xs-2">
                       <label for="nit" > Cilindraje: </label>
                        <input name="cilindraje_vehiculo" type="text" class="form-control" >
                      </div>

                  <div class="col-xs-3">
                   <label for="nombre_articulo" > Modelo Vehiculo </label>
                    <textarea name="modelo_vehiculo" type="text" class="form-control" rows="4"></textarea>
                  </div>
              ...
              <div >
                ...
                <button style="position: fixed; bottom: 104px; right: 34px;"  type="submit" class="btn btn-success">
                    <p class="rotate">Agregar Tipovehiculo</p>
                </button>
